...
public final class PersistencyAccess {
    ...
    public PersistencyAccess(Database database, StructureRegistry structureRegistry) {
    ...
    public void initialize() {
        ...
        this.behaviorStoredData = new StructureBehaviorStoredData(structureRegistry, this);
    }
